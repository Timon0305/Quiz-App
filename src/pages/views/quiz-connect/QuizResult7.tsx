...
export const QuizResult7 = <IonCol class='test-back'>
    <IonCard className='test-card'>
        <IonCardContent className='test-card-result ion-text-center'>
            <IonText className='text-bold font-20'>Parfait !</IonText>
        </IonCardContent>
    </IonCard>
    ...
    <IonGrid className='test-checkgroup'>
        <div className="video-resume">
            <div className='ml-3 mr-3 mt-3'>
                <p className='font-14'>Tu as réussi 90-100% de l’examen</p>
                <IonProgressBar className='progress-height' color='danger' value={0.9}/>
            </div>
            <div className='ion-text-center mb-51 mt-20'>
                ...
                <IonText className='font-14 text-bold'>
                    tu connais très bien tes cours, continue comme ca !!!
                </IonText>
            </div>
        </div>
    </IonGrid>
