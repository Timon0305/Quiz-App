...
export const QuizResult5 = <IonCol class='test-back'>
    <IonCard className='test-card'>
        <IonCardContent className='test-card-result ion-text-center'>
            <IonText className='text-bold font-20'>C’est bien !</IonText>
        </IonCardContent>
    </IonCard>
    ...
    <IonGrid className='test-checkgroup'>
        <div className="video-resume">
            <div className='ml-3 mr-3 mt-3'>
                <p className='font-14'>Tu as réussi 60-75% de l’examen</p>
                <IonProgressBar className='progress-height' color='danger' value={0.6}/>
            </div>
