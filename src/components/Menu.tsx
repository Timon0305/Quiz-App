      ...
      <IonContent>
        ...
        <IonList id="inbox-list" lines="full">
          ...
          {trainingPages.map((trainingPage, index) => {
            return (
              <IonMenuToggle key={index} autoHide={false}>
                <IonItem className={location.pathname === trainingPage.url ? 'selected' : ''} routerLink={trainingPage.url} routerDirection="none" lines="none" detail={false}>
          ...
          {formaceoPages.map((formaceoPage, index) => {
            return (
              <IonMenuToggle key={index} autoHide={false}>
                <IonItem className={location.pathname === formaceoPage.url ? 'selected' : ''} routerLink={formaceoPage.url} routerDirection="none" lines="none" detail={false}>
